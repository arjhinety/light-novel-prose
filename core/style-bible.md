...
These are targets, not quotas. See [Rhythm & Flow](rhythm-and-flow.md) for how to hit them without sounding mechanical.
...
> "Ah, wait for me! I'm almost done!" Matsuri hopped in place.
> "It's fine. I'm go-home club anyway." Kuze tied off the trash bag. "It doesn't take two people to hand in a log."
...
What it shows: a sound-effect opener, a scene-setting exhale, a punchline jab, honorifics, a character-marking gesture, a quote-back ("For you guys"), a silent beat, the three-question chain, self-suspicion, the leitmotif introduced, and a tilt ending ("Probably.").
...
- **Body-language tags** replace dialogue tags: "Tachibana slammed both hands on his desk."
...
- **Tag with action**, not "exclaimed/retorted/interjected". "Said" is fine, and nothing is better.
...
| `--` | Interruption, or a time stamp ("The next day--") |
...
| Italics | Quoted-back phrases and in-world text, used sparingly |
...
> "I was, um, checking if there was anything dangerous on the floor! You know?"
> "Ah. Be careful, then."
...
It has a sound-effect-like interjection, a cat simile for comic precision, the silent beat, a POV inference marked as easy ("It did not take a detective."), the flustered excuse with stutters and a comic doubling-down, the question chain rising from the leitmotif, self-suspicion, and a refusal verdict.
...
For deeper personality work, see [Dere Types](../cast/dere-types.md) and [Character Tropes](../cast/character-tropes.md).
...
6. **"Every line needs a tag."** No. Distinct voices identify themselves. Tags are clutter.
